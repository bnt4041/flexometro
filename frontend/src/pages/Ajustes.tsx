 ...
 *  admin de su organización, al diccionario y a la traducción — el mismo
 *  destino al que llevan las ruedas dentadas de la barra lateral. Los
 *  ajustes propios de cada módulo (numeración...) viven ahora en la propia
 *  pantalla de Módulos, junto al interruptor de activar/desactivar. */
